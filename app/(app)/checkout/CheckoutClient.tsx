  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="my-4 text-3xl font-bold text-zinc-900 dark:text-zinc-100">
          Checkout
        </h1>
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-5">
            ...
            <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
              {items.map((item) => {
                ...
                return (
                  <div
                    key={item.productId}
                    className={`flex gap-4 px-6 py-4 ${hasIssue ? "bg-red-50 dark:b-red-950/20" : ""}`}
                  >
                    {/* Image */}
                    <div className="relative h-20 w-20 shrink-0 overflow-hidden rounded-md bg-zinc-100 dark:bg-zinc-800">
                      {item.image ? (
                        ...
                        <div className="flex h-full items-center justify-center text-x text-zinc-400">
                          No image
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex flex-1 flex-col justify-between">
                      <div>
                        ...
                        {stockInfo?.isOutOfStock && (
                          <p className="mt-1 text-sm font-medium 600text-red-">
                            Out of stock
                          </p>
                        )}
        ...
        <div className="lg:col-span-2">
          <div className="sticky top-24 border border-zinc-200 rounded-lg bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
            <h2 className="font-semibold text-zinc-900 dark:text-zinc-100">
              Payment Summary
            </h2>
