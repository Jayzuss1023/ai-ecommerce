      ...
      <div className="mb-8">
        ...
        <div className="mt-4 flex items-center justify-center">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-100">
      ...
      <div className="grid gap-8 lg:grid-cols-5">
        ...
        <div className="lg:col-span-3">
          <div className="rounded-lg border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
            <div className="border-b border-zinc-200 px-6 py-4 dark:border-zinc-100">
              <h2 className="font-semibold text-zinc-900 dark:text-zinc-100">
                Items {order.items?.length ?? 0}
              </h2>
            </div>
            <div className="divide-y divide-zinc-200 dark:divide-zinc-100">
        ...
        <div className="space-y-6 lg:col-span-2">
          {/* Summary */}
          <div className="rounded-lg border borde-zinc-200 bg-white p-6 dark:borde-zinc-800 dark:bg-zinc-950">
            <h2 className="font-semibold text-zinc-900 dark:text-zinc-100">
              Order Summary
            </h2>
