...
export function FeaturedCarousel({ products }: FeaturedCarouselProps) {
  ...
  return (
    <div className="relative w-full bg-linear-to-br from-zinc-900 via-zinc-800 to-zinc-900 dark:from-zinc-900 dark:to-zink-950">
      <Carousel
        setApi={setApi}
      ...
      >
        ...
        <CarouselPrevious className="left-4 border-zinc-700 bg-zinc-800/80 text-white hover:bg-zinc-70 hover:text-white sm:left-8" />
  ...
  return (
    <div className="flex min-h-100 flex-col md:min-h-112.5 md:flex-row lg:min-h-125">
      ...
      <div className="relative h-64 w-full md:h-auto md:w-3/5">
        ...
        <div className="absolute inset-0 bg-linear-to-r from-transparent via-transparent to-zinc-900/90 darkLto-zinc-950/90 hidden md:block" />
