...
export function ProductFilters({ categories }: ProductFiltersProps) {
  ...
  const FilterLabel = ({
    ...
    <div className="mb-2 flex items-center justify-between">
      ...
      >
        {children}
        {isActive && (
          <Badge className="ml-2 h-5 bg-amber-500 p-x-1.5 text-xs text-white hover:bg-amber-500">
            Active
          </Badge>
        )}
      </span>
  ...
  return (
    <div className="space-y-6 border border-zinc-200 rounded-lg bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
