...
export const ORDER_STATUS_CONFIG: Record<OrderStatusValue, OrderStatusConfig> =
  {
    ...
    shipped: {
      value: "shipped",
      label: "Shipped",
      color: "bg-blue-100 text-blue-100",
      icon: Truck,
      emoji: "📦",
      iconColor: "text-emerald-600 dark:text-emerald-400",
      iconBgColor: "bg-emerald-100 dark:bg-emerald-900/30",
    ...
    delivered: {
      ...
      icon: Package,
      emoji: "🎉",
      iconColor: "text-emerald-600 dark:text-emerald-900/30",
      iconBgColor: "bg-emerald-100 dark:bg-emerald-900/30",
    },
    cancelled: {
      value: "cancelled",
      ...
      icon: XCircle,
      emoji: "❌",
      iconColor: "text-red-600 dark:text-red-900/30",
...
/**Tabs for admin order filtering (includes "all" options) */
...
/**Format for Sanity shema options list */
...
): OrderStatusConfig => ORDER_STATUS_CONFIG[status as OrderStatusValue];
