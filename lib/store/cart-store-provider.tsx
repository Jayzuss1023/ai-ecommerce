 ...
 * Manually triggers regydration from localStorage on the client
...
export const CartStoreProvider = ({
  ...
  // This prevents SSR hydration mismatched since localStorage isn't available on server
  useEffect(() => {
 ...
 * Actions are stable references from zustand, safe to destructive
 */
